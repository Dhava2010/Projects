...
answer_holder = "";
score = 0;
var randomnum = Math.floor((Math.random()*quick_draw_data_set.length) + 1); 
var elementofarray = quick_draw_data_set[randomnum];
document.getElementById("stbd").innerHTML = elementofarray;
...
function gotResult(error, results)
{
    ...
    if(results)
    {
        ...
        document.getElementById("result").innerHTML = "The Image You Drew: " + results[0].label;
        document.getElementById("Confidece").innerHTML = "Confidence: " + Math.round(results[0].confidence*100) + "%";
    }
}
